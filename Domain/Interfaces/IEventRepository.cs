...
namespace Domain.Interfaces
{
    public interface IEventRepository
    {
        ...
        public Task<Event> UpdateAsync(Guid id, Event _event, CancellationToken cancellationToken);
        public Task<Event> DeleteAsync(Guid id, CancellationToken cancellationToken);
